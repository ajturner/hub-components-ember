...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(o){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("hub-components-ember/app").default.create({name:"hub-components-ember",version:"0.0.0+7562f850"})
